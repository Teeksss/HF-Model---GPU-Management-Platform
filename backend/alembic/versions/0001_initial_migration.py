...
def upgrade():
    ...
    # Model metadata tablosu oluştur
    ...
    # Model versiyon tablosu oluştur
    op.create_table('model_versions',
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('model_id', 'version', name='uix_model_version')
    )
    op.create_index(op.f('ix_model_versions_id'), 'model_versions', ['id'], unique=False)
    
    # GPU kullanım tablosu oluştur
...
def downgrade():
    ...
    op.drop_index(op.f('ix_gpu_usage_id'), table_name='gpu_usage')
